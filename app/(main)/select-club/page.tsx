        ...
        <div className="min-h-screen bg-[#0A0E17] text-white p-5 pb-20 relative">
            ...
            <header className="mb-8">
                ...
                <div className="flex items-center gap-2">
                    <h1 className="text-[28px] font-black italic tracking-tighter uppercase">Select Club</h1>
                    <span className="text-xs bg-blue-600 px-2 py-0.5 rounded font-bold">NEW PAGE v3</span>
                </div>
